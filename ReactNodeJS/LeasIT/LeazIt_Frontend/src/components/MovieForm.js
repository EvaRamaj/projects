                ...
                <Card style={style} className="md-block-centered">
                    <form className="md-grid" onSubmit={this.handleSubmit} onReset={() => this.props.history.goBack()}>
                        ...
                        <Button id="submit" type="submit"
                                disabled={this.state.year.toString().length != 4 || this.state.name == undefined || this.state.name == '' || this.state.year == undefined || this.state.year == '' || this.state.synopsis == undefined || this.state.synopsis == ''}
