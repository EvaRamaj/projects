...
var LinkedIn = exports.LinkedIn = function (_Component) {
  ...
  function LinkedIn() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.getUrl = function () {
      ...
      var linkedInAuthenLink = 'https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=' + clientId + '&redirect_uri=' + redirectUri + '&state=fdsf78fyds7fm';
...
LinkedIn.defaultProps = {
  ...
  disabled: false,
  children: _react2.default.createElement('img', { src: require('../assets/linkedin.png'), alt: 'Log in with Linked In', style: { maxWidth: '180px' } })
};
